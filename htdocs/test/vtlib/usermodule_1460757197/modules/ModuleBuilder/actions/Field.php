...
class ModuleBuilder_Field_Action extends Settings_Vtiger_Index_Action 
{
    ...
    public function save( Vtiger_Request $request ) 
	{
		...
		$_SESSION['tks_module_builder'][$token]['fields'][$fieldId]['defaultvalue'] 	   	= $this->getBool($request->get('defaultvalue'));
		$_SESSION['tks_module_builder'][$token]['fields'][$fieldId]['fieldDefaultValue']	= $defaultValue;
		$_SESSION['tks_module_builder'][$token]['fields'][$fieldId]['tksfilterfield']   	= $this->getBool($request->get('tksfilterfield'));
