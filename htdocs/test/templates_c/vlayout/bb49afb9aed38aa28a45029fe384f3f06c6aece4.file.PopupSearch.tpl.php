<?php /* Smarty version Smarty-3.1.7, created on 2016-04-21 09:52:42
         compiled from "/var/www/htdocs/includes/runtime/../../layouts/vlayout/modules/Vtiger/PopupSearch.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16134279915718a2ea9dce23-00104414%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bb49afb9aed38aa28a45029fe384f3f06c6aece4' => 
    array (
      0 => '/var/www/htdocs/includes/runtime/../../layouts/vlayout/modules/Vtiger/PopupSearch.tpl',
      1 => 1460824742,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16134279915718a2ea9dce23-00104414',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5718a2eaaaf0c',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5718a2eaaaf0c')) {function content_5718a2eaaaf0c($_smarty_tpl) {?>
...
</strong></button><?php }?><?php }else{ ?>&nbsp;<?php }?></div><div class="span6"><form class="form-horizontal popupSearchContainer" onsubmit="return false;" method="POST"><div class="control-group margin0px"><input  style="display:none;" class="span2" style="display:none;" type="text" placeholder="<?php echo vtranslate('LBL_TYPE_SEARCH');?>
" id="searchvalue"/>&nbsp;&nbsp;<span  style="display:none;"><strong><?php echo vtranslate('LBL_IN');?>
</strong></span>&nbsp;<span><?php $_smarty_tpl->tpl_vars['defaultSearchField'] = new Smarty_variable($_smarty_tpl->tpl_vars['RECORD_STRUCTURE_MODEL']->value->getModule()->getDefaultSearchField(), null, 0);?><select style="width: 140px; display:none;" class="chzn-select22" id="searchableColumnsList"><?php  $_smarty_tpl->tpl_vars['fields'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['fields']->_loop = false;
...
</option></optgroup><?php } ?><?php } ?></select></span>&nbsp;&nbsp;<select style="width: 140px;" class="chzn-select"id="filterProductsList" onchange="$('#searchvalue').val($(this).val());$('#searchableColumnsList').val('productcategory');$('#popupSearchButton button').click();"><optgroup><option value="" selected="">Alle</option></optgroup><optgroup><option value="Smart Repair">Smart Repair</option></optgroup><optgroup><option value="Verkauf">Verkauf</option></optgroup></select>&nbsp;&nbsp;<span id="popupSearchButton"><button class="btn"><i class="icon-search " title="<?php echo vtranslate('LBL_SEARCH_BUTTON');?>
"></i></button></span></div></form></div><span style="font-weight:700;">TEST SBA</span><div class="span4"><?php if ($_smarty_tpl->tpl_vars['SOURCE_MODULE']->value!='PriceBooks'&&$_smarty_tpl->tpl_vars['SOURCE_FIELD']->value!='productsRelatedList'){?><div class="popupPaging"><div class="row-fluid"><span class="span3" style="float:right !important;min-width:230px"><span class="pull-right"><span class="pageNumbers"><span class="pageNumbersText"><?php if (!empty($_smarty_tpl->tpl_vars['LISTVIEW_ENTRIES']->value)){?><?php echo $_smarty_tpl->tpl_vars['PAGING_MODEL']->value->getRecordStartRange();?>
