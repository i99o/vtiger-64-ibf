<?php /* Smarty version Smarty-3.1.7, created on 2016-04-19 11:39:06
         compiled from "/var/www/htdocs/includes/runtime/../../layouts/vlayout/modules/Inventory/LineItemsContent.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1304567920571618da547985-37988900%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a1fd7651d6af97750a27035573c34b4ae2d09f6a' => 
    array (
      0 => '/var/www/htdocs/includes/runtime/../../layouts/vlayout/modules/Inventory/LineItemsContent.tpl',
      1 => 1432538786,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1304567920571618da547985-37988900',
  'function' => 
  array (
  ),
  'variables' => 
...
" style="vertical-align:middle"></i><?php }elseif((!$_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['productDeleted']->value])){?><img class="<?php if ($_smarty_tpl->tpl_vars['PRODUCT_ACTIVE']->value){?>lineItemPopup<?php }?> cursorPointer alignMiddle" data-popup="ProductsPopup" data-module-name="Products" title="<?php echo vtranslate('Products',$_smarty_tpl->tpl_vars['MODULE']->value);?>
" data-field-name="productid" src="<?php echo vimage_path('Products.png');?>
...
<?php }else{ ?>0<?php }?>" type="text" data-validation-engine="validate[required,funcCall[Vtiger_PositiveNumber_Validator_Js.invokeValidation]]" class="listPrice smallInputBox" list-info='<?php if (!empty($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['listPrice']->value])){?><?php echo Zend_Json::encode($_smarty_tpl->tpl_vars['listPriceValues']->value);?>
<?php }?>'/>&nbsp;<?php $_smarty_tpl->tpl_vars['PRICEBOOK_MODULE_MODEL'] = new Smarty_variable(Vtiger_Module_Model::getInstance('PriceBooks'), null, 0);?><?php if ($_smarty_tpl->tpl_vars['PRICEBOOK_MODULE_MODEL']->value->isPermitted('DetailView')){?><img src="<?php echo vimage_path('PriceBooks.png');?>
...
<?php }else{ ?>0<?php }?></div><div id="discountTotal<?php echo $_smarty_tpl->tpl_vars['row_no']->value;?>
...
<?php }else{ ?>0<?php }?></div><div id="taxTotal<?php echo $_smarty_tpl->tpl_vars['row_no']->value;?>
...
<?php }else{ ?>0<?php }?></div></td><td><span id="netPrice<?php echo $_smarty_tpl->tpl_vars['row_no']->value;?>
